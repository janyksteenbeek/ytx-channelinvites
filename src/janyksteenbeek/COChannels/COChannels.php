<?php namespace janyksteenbeek\COChannels;
...
class COChannels {
    ...
    public function addChannel($channels, $canViewRevenue = true, $webClaiming = true) {
        ...
        if(!$result = $this->call('https://www.youtube.com/my_channels_ajax', array(
            'usernames' => $channels,
    ...
    public function removeChannel($channels) {
        ...
        if(!$result = $this->call('https://www.youtube.com/my_channels_ajax?action_remove=1', array(
            'channels' => $channels,
            'session_token' => $this->sessionKey,
            'so' => 'tcld',
            'sq' => '',
